            ...
            while(contatore_lunghezza_frase < lunghezza_frase_generata){
                ...
                while (fgetws(line, sizeof(line), fp)){
                    ...
                    if ( conteggio == parola_inizio_frase ||  (wcscmp(parola_da_cercare, token) == 0)){
                        ...
                        //nonostante la somma fosse esattamente 1 ho inserito una soglia per il confronto, se quindi la somma - 1 = numero maggiore di 0.0001 va in errore poichè vuol dire che somma > 1 
                        double checksum = 0;
